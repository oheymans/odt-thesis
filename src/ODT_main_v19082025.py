...
class Parameters:
    ...
    processing_dir = r"\\tudelft.net\staff-umbrella\VKhandan\ODT Data\Kidney\Sample1\NS_2BB1BABB_Ext3"
    ...
    # Pixel dimensions in cm (converted from micrometers), shape: (2,) (np.ndarray of float)
